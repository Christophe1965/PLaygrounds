...
//  MaPremiereVueDeLaTable
//
//  Created by Christophe Delaporte on 09/02/2017.
...
class TheTableViewController: UITableViewController {
        ...
        var shoppingList = ["Tomatoes", "Apple", "Avocado", "Potatoes", "Carrots", "Salad", "Red Wine"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.imageView?.image =  #imageLiteral(resourceName: "vegetables")
